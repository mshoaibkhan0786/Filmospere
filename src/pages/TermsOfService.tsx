...
const TermsOfService: React.FC = () => {
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0a', color: '#fff', padding: '2rem' }}>
            <Helmet>
                <title>Terms of Service - Filmospere</title>
                <meta name="description" content="Terms of Service for using Filmospere's movie discovery platform." />
            </Helmet>
            ...
            <div className="container" style={{ maxWidth: '900px', margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ lineHeight: '1.8', color: '#ccc' }}>
                        For questions about these Terms of Service, visit our <Link to="/contact" style={{ color: '#e50914' }}>Contact Page</Link>.
                    </p>
                </section>
            </div>
        </div>
