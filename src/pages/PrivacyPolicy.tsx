...
const PrivacyPolicy: React.FC = () => {
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0a', color: '#fff', padding: '2rem' }}>
            <Helmet>
                <title>Privacy Policy - Filmospere</title>
                <meta name="description" content="Filmospere's Privacy Policy explains how we collect, use, and protect your data." />
            </Helmet>
            ...
            <div className="container" style={{ maxWidth: '900px', margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '2rem' }}>
                    ...
                    <p style={{ lineHeight: '1.8', color: '#ccc' }}>
                        If you have questions about this Privacy Policy, please visit our <Link to="/contact" style={{ color: '#e50914' }}>Contact Page</Link>.
                    </p>
                </section>
            </div>
        </div>
